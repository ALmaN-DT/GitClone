...
namespace IntroWinForms
{
    ...
    public class GrayscaleConverter<T>
                    : MyImageConverter<T> where T : IMyImage, IMyImageConverterDefault<T>
    {
    ...
    public class GrayWorldConverter<T> : MyImageConverter<T> where T : IMyImage, IMyImageConverterDefault<T>
    {
        public T Convert(T source)
        {
            var dist = new MyImage(source.Width, source.Height);
...
object img = dist;
    ...
    public class NonLinearConverter<T> : MyImageConverter<T> where T : IMyImage, IMyImageConverterWithParams<T>
{
